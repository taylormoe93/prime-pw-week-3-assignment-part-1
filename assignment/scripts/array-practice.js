...
let foodsArray = ['pho', 'burrito', 'curry', 'teriyaki'];
...
foodsArray.push('soup');
console.log('Added a food to the end,', foodsArray);
...
foodsArray.unshift('moreSoup');
console.log('Added food to the beginning:', foodsArray);
